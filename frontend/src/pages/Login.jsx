      ...
      <div className="w-full max-w-sm">
        ...
        <div className="card">
          ...
          <a
            ...
            className="mt-4 flex items-center justify-center gap-2 w-full bg-gray-800 hover:bg-gray-700 text-white font-medium py-2 rounded-lg text-sm transition-colors"
          >
